            ...
            <Card sx={{ width: 1 }} >
                <div className='CreateCampaignForm'>
                    ...
                    <form onSubmit={(e) => {
                        ...
                        <TextField sx={sx}  fullwidth type={'text'} label="Title of the Campaign" onChange={(e) => {
                            setCampaignName(e.target.value);
                        }} >

                        </TextField>

                        <TextField sx={sx}  fullwidth type={'text'} label="Slogan of the Project" onChange={(e) => {
                        ...
                        <TextField  sx={sx} fullwidth type={'text'} label="Image URL" onChange={(e) => {
                            setImageurl(e.target.value);
                        }} >

                        </TextField>

                        <TextField  sx={sx} fullwidth type={'number'} label="Target to Achieve" InputProps={{
                            endAdornment: <InputAdornment position="end">ETH</InputAdornment>,
                        }} onChange={(e) => {
                        ...
                        <TextField  sx={sx} fullwidth type={'text'} label="Description of the Project" onChange={(e) => {
                            setDescription(e.target.value);
                        }} >

                        </TextField>

                        <TextField  sx={sx} fullwidth type={'text'} label="Enter project Link" onChange={(e) => {
